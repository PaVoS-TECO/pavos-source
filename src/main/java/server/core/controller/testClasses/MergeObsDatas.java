...
public class MergeObsDatas {
	...
	public MergeObsDatas(String topic1, String topic2, String outputTopic, String key) {
	...
	public MergeObsDatas() {
		this("Observations", "Datastreams", "ObservationsMerges1", "Observations");
	}
