 ...
 */
package server.core.observation;
...
public class Observation extends org.apache.avro.specific.SpecificRecordBase
	 ...
	 */
	public static server.core.observation.Observation.Builder newBuilder() {
		return new server.core.observation.Observation.Builder();
	}
	 ...
	 */
	public static server.core.observation.Observation.Builder newBuilder(
			server.core.observation.Observation.Builder other) {
		return new server.core.observation.Observation.Builder(other);
	}
	 ...
	 * @return A new Observation RecordBuilder
	 */
	public static server.core.observation.Observation.Builder newBuilder(server.core.observation.Observation other) {
		return new server.core.observation.Observation.Builder(other);
	}
	...
	public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Observation>
		 ...
		 * @param other The existing Builder to copy.
		 */
		private Builder(server.core.observation.Observation.Builder other) {
			super(other);
		 ...
		 * @param other The existing instance to copy.
		 */
		private Builder(server.core.observation.Observation other) {
			super(SCHEMA$);
			if (isValidValue(fields()[0], other.iotId)) {
				this.iotId = data().deepCopy(fields()[0].schema(), other.iotId);
				fieldSetFlags()[0] = true;
		 ...
		 * @return This builder.
		 */
		public server.core.observation.Observation.Builder setIotId(java.lang.CharSequence value) {
		 ...
		 * @return This builder.
		 */
		public server.core.observation.Observation.Builder clearIotId() {
			iotId = null;
		 ...
		 * @return This builder.
		 */
		public server.core.observation.Observation.Builder setPhenomenonTime(java.lang.CharSequence value) {
		 ...
		 * @return This builder.
		 */
		public server.core.observation.Observation.Builder clearPhenomenonTime() {
			phenomenonTime = null;
		 ...
		 * @return This builder.
		 */
		public server.core.observation.Observation.Builder setResultTime(java.lang.CharSequence value) {
		 ...
		 * @return This builder.
		 */
		public server.core.observation.Observation.Builder clearResultTime() {
			resultTime = null;
		 ...
		 * @return This builder.
		 */
		public server.core.observation.Observation.Builder setResult(java.lang.CharSequence value) {
		 ...
		 * @return This builder.
		 */
		public server.core.observation.Observation.Builder clearResult() {
			result = null;
		 ...
		 * @return This builder.
		 */
		public server.core.observation.Observation.Builder setResultQuality(java.lang.CharSequence value) {
		 ...
		 * @return This builder.
		 */
		public server.core.observation.Observation.Builder clearResultQuality() {
			resultQuality = null;
		 ...
		 * @return This builder.
		 */
		public server.core.observation.Observation.Builder setValidTime(java.lang.CharSequence value) {
		 ...
		 * @return This builder.
		 */
		public server.core.observation.Observation.Builder clearValidTime() {
			validTime = null;
		 ...
		 * @return This builder.
		 */
		public server.core.observation.Observation.Builder setDatastream(java.lang.CharSequence value) {
		 ...
		 * @return This builder.
		 */
		public server.core.observation.Observation.Builder clearDatastream() {
			Datastream = null;
		 ...
		 * @return This builder.
		 */
		public server.core.observation.Observation.Builder setFeatureOfInterest(java.lang.CharSequence value) {
		 ...
		 * @return This builder.
		 */
		public server.core.observation.Observation.Builder clearFeatureOfInterest() {
